                    ...
                    <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="firstName" name="nom" value="{{$user->nom}}"
                                    autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="organization" class="form-label">Fonction</label>
                                <input type="text" class="form-control" id="organization" name="role" value="{{$user->role}}" />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="phoneNumber">Numero de telephone</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text">CIV (+225)</span>
                                    <input type="text" id="phoneNumber" name="telephone" class="form-control" value="{{$user->telephone}}" />
                                </div>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="address" class="form-label">Adresse</label>
                                <input type="text" class="form-control" id="address" name="address" value="{{$user->adresse}}" />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="state" class="form-label">lieux de naissance</label>
                                <input class="form-control" type="text" id="state" name="state" value="{{$user->ville_naissance}}" />
                            </div>

                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="country">date de naissance</label>
                                <input type="date" class="form-control pl-3 pr-4" name="date_naissance" value="{{$user->date_naissance}}" />
