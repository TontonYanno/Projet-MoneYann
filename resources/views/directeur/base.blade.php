        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('comptedirecteur') }}" class="menu-link ">
                            <i class='bx bxs-bank bx-tada'></i>
                            <div data-i18n="Account Settings">Creation de Comptes</div>
                        </a>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('depotdirecteur') }}" class="menu-link ">
                            <i class='bx bx-transfer bx-tada'></i>
                            <div data-i18n="Account Settings">Depot</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('retraitdirecteur') }}" class="menu-link ">
                            <i class='bx bx-transfer bx-tada'></i>
                            <div data-i18n="Account Settings">Retrait</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('transfertdirecteur') }}" class="menu-link ">
                            <i class='bx bx-transfer bx-tada'></i>
                            <div data-i18n="Account Settings">Transfert</div>
                        </a>
                    </li>

                    <li class="menu-item">
                        <a href="{{ route('profiledirecteur') }}" class="menu-link ">
